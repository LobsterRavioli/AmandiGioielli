...
public class UserDAO implements GenericDAO<UserBean> {
	...
	String insertSQL = "INSERT INTO user (first_name, last_name, email, password, newsletter) "
		+ "VALUES (?, ?, ?, ?, ?)";
	try {
	    ...
	    preparedStatement.setBoolean(5, user.getNewsletter());
	...
	String insertSQL = "UPDATE user first_name = ?, last_name = ?, email = ?, "
